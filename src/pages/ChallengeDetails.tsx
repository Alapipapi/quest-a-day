    ...
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center py-16">
          <p className="text-gray-500 dark:text-gray-400">Challenge details not found.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
        <div className="bg-gradient-to-r from-primary/10 to-primary/5 p-6 sm:p-8 dark:from-primary/5 dark:to-transparent">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-100">{challenge.title}</h1>
            {isCompleted && (
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-300 capitalize">{category} Challenge</p>
        </div>

        <div className="p-6 sm:p-8 space-y-8">
          <div>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Your Progress</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Instructions</h2>
            <div className="space-y-2">
              {challenge.instructions.map((instruction: string, index: number) => (
                ...
                >
                  <div className="mt-0.5 min-w-5 h-5 rounded-full bg-primary/10 dark:bg-primary/20 flex items-center justify-center text-primary font-medium text-sm">
                    {index + 1}
                  </div>
          ...
          {challenge.resources && challenge.resources.length > 0 && (
            <div>
              <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Helpful Resources</h2>
          ...
          {challenge.verification && challenge.verification.length > 0 && (
            <div>
              <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Verification Checklist</h2>
              <div className="space-y-2">
